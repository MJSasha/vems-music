...
namespace UnitTests
{
    public class DBRedactionControllerTest
    {
        ...
        public void AddGenreTest()
        {
            ...
            Assert.Equal("~/DBRedaction/Complete/Жанр добавлен", redirectResult.Url);
        }
        [Fact]
        public void AddGroupTest()
        {
            ...
            var redirectResult = Assert.IsType<RedirectResult>(result);
            Assert.Equal("~/DBRedaction/Complete/Группа добавлена", redirectResult.Url);
        }
        [Fact]
        public void AddMusicTest()
        {
            ...
            var redirectResult = Assert.IsType<RedirectResult>(result);
            Assert.Equal("~/DBRedaction/Complete/Трек добавлен", redirectResult.Url);
        }
        ...
        public void DeleteGenreTest()
        {
            ...
            var redirectResult = Assert.IsType<RedirectResult>(result);
            Assert.Equal("~/DBRedaction/Complete/Жанр удален", redirectResult.Url);
        }
        [Fact]
        public void DeleteGroupTest()
        {
            ...
            var redirectResult = Assert.IsType<RedirectResult>(result);
            Assert.Equal("~/DBRedaction/Complete/Группа удален", redirectResult.Url);
        }
        [Fact]
        public void DeleteMusicTest()
        {
            ...
            var redirectResult = Assert.IsType<RedirectResult>(result);
            Assert.Equal("~/DBRedaction/Complete/Трек удален", redirectResult.Url);
        }
